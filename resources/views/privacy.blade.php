...
@section('title', 'Privacy Policy — Tunara')
...
<section style="max-width:780px;margin:0 auto;padding:120px 48px 80px;">
    ...
    <h1 style="font-size:clamp(28px,4vw,48px);font-weight:800;letter-spacing:-0.03em;margin-bottom:16px;">{{ $page->title ?? 'Privacy Policy' }}</h1>
